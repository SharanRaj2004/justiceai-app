...
import { Scale, User, Info } from 'lucide-react';
...
export default function ChatBubble({ role, content, timestamp }) {
  ...
  if (isSystem) {
    return (
      ...
      >
        <div className="bg-void border-2 border-white/10 px-6 py-2 rounded-sm shadow-hard flex items-center justify-center gap-3">
